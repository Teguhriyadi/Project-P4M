					...
					<nav class="classy-navbar justify-content-between" id="academyNav">
						...
						<div class="classy-menu">
							...
							<div class="classynav">
								<ul>
									...
									<li>
										<a href="./berita.html" title="Berita">Berita</a>
									</li>
									<li>
						...
						<div class="calling-info">
							<div class="call-center">
								<a href="tel:0000000" ><i class="icon-telephone-2"></i></a>
							</div>
						</div>
					</nav>
				</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8">
					...
					<div id="main">
						<div class="main">
							<div class="main_title">Prakata Kepala Sekolah</div>
							<div class="main_body">
								<div class="row">
									<div class="col-md-12">
										<img class="img-fluid" src="{{ url('/frontend') }}/img/logo-kabupaten.png" alt="" width="250" align="left" style="margin:5px 20px 20px 0px">
