                        ...
                        <ul class="nav nav-tabs">
                            @foreach ($data_status_dasar as $status_dasar)
                                <li {{ $status_dasar ? 'active' : '' }}>
                                    <a href="#tab_{{ $status_dasar->id }}" onclick="tabPane({{ $status_dasar->id }})"
                                        data-toggle="tab">{{ $status_dasar->nama }}</a>
                                </li>
                            @endforeach
                        </ul>
                                        ...
                                        <div class="box box-info">
                                            <div class="box-header">
                                                <div class="btn-group btn-group-vertical">
                                                    <a class="btn btn-social btn-flat btn-primary btn-sm"
                                                        data-toggle="dropdown" title="Tambah Penduduk">
                                                        <i class="fa fa-plus"></i> Tambah Penduduk
                                                    </a>
                                                    <ul class="dropdown-menu" role="menu">
                                                        <li>
                                                            <a href="{{ url('/page/admin/kependudukan/penduduk/tambah_penduduk_lahir') }}"
                                                                class="btn btn-social btn-flat btn-block btn-sm"
                                                                title="Tambah Data Penduduk Lahir">
                                                                <i class="fa fa-plus"></i> Penduduk Lahir
                                                            </a>
                                                            <a href="{{ url('/page/admin/kependudukan/penduduk/tambah_penduduk_masuk') }}"
                                                                class="btn btn-social btn-flat btn-block btn-sm"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="btn-group">
                                                                            ...
                                                                            <ul class="dropdown-menu" role="menu">
                                                                                <li>
                                                                                    <a href="{{ url('page/admin/kependudukan/penduduk/' . $p->id) }}"
                                                                                        class="btn btn-social btn-flat btn-block btn-sm"><i
                                                                                            class="fa fa-list-ol"></i> Lihat
                                                                                        Detail Biodata Penduduk</a>
                                                                                </li>
                                                                                <li>
                                                                                    <a href="{{ url('page/admin/kependudukan/penduduk/' . $p->id . '/edit') }}"
                                                                                        class="btn btn-social btn-flat btn-block btn-sm"><i
                                                                                            class="fa fa-edit"></i> Ubah
                                                                                        Biodata Penduduk</a>
                                                                                </li>
                                                                                <li>
                                                                                    <a href="{{ url('page/admin/kependudukan/penduduk/' . $p->id . '/cetak') }}"
                                                                                        target="_blank"
                                                                                        class="btn btn-social btn-flat btn-block btn-sm"><i
                                                                                ...
                                                                                <li>
                                                                                    <a href="#"
                                                                                        onclick="editStatusDasar({{ $p->id }})"
                                                                                        data-remote="false"
                                                                                        data-toggle="modal"
                                                                                        data-target="#modalStatusDasar"
                                                                                        class="btn btn-social btn-flat btn-block btn-sm"><i
                                                                                ...
                                                                                <li>
                                                                                    <form
                                                                                        action="{{ url('page/admin/kependudukan/penduduk/' . $p->id) }}"
                                                                                        method="post">
                                                                                        @csrf
                                                                                        @method('delete')
                                                                                        <button
                                                                                            class="btn btn-social btn-flat btn-block btn-sm btn-delete"><i
                                                                    ...
                                                                    <td>{{ $p->getRw->rw }}</td>
                                                                    <td>{{ $p->getRt->rt }}</td>
                                                                    <td>{{ date('Y') - date('Y', strtotime($p->tgl_lahir)) }}
                                                                    </td>
                                                                    <td>{{ $p->created_at->formatLocalized('%d %B %Y') }}
                                                                    </td>
                                                                    <td>{{ $p->updated_at->formatLocalized('%d %B %Y') }}
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                        </tbody>
    ...
    <div class="modal fade" id="modalStatusDasar">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ url('/page/admin/kependudukan/penduduk/simpan_status_dasar') }}" method="POST"
                    id="formEditDusun">
                    @method('PUT')
                    @csrf
