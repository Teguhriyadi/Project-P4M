        ...
        <div class="col-md-6">
            <div class="box box-info">
                <div class="box-header">
                    ...
                    <a href="{{ url('/data/pendidikan') }}" target="_blank" class="btn btn-social btn-info btn-flat btn-sm pull-right" style="margin-left: 5px" title="Lihat">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button onclick="editDataPendidikan({{$data->id}})" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#modal-default-edit" title="Ubah Data">
                                            <i class="fa fa-edit"></i>
                                        </button>
                                        <form action="{{ url('/page/admin/data/pendidikan/'.$data->id) }}" method="POST" style="display: inline;" title="Hapus Data">
                                            @method("DELETE")
                                            @csrf
...
<script>
    ...
    function drawChart() {
        ...
        <?php foreach ($data_penduduk_pendidikan as $data): ?>
