        ...
        <div class="col-md-6">
            <div class="box">
                <div class="box-header">
                    ...
                    <a href="/data/wilayah-administratif" target="_blank" class="btn btn-info btn-sm pull-right" style="margin-left: 5px"><i class="fa fa-eye"></i> Preview</a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button onclick="editDataDusun({{$data->id}})" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#modal-default-edit">
