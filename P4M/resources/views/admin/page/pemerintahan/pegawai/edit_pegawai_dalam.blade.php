...
<section class="content">
    ...
    <div class="row">
        <form action="{{ url('/page/admin/pemerintahan/pegawai/'.$edit->id.'/dalam') }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
            @method("PUT")
            @csrf
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control input-sm" name="nama" id="nama" placeholder="Nama" value="{{ $penduduk->nama }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="nik" class="col-sm-4 control-label"> Nomor Induk Kependudukan </label>
                            <div class="col-sm-7">
                                <input type="text" class="form-control input-sm" name="nik" id="nik" placeholder="Nomor Induk Kependudukan" value="{{ $penduduk->nik }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control input-sm" name="tempat_lahir" id="tempat_lahir" placeholder="Tempat Lahir" value="{{ $penduduk->tempat_lahir }}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <div class="input-group date">
                                    ...
                                    <input type="text" class="form-control pull-right" id="datepicker" name="tgl_lahir" value="{{ old('tgl_lahir') }} {{ $penduduk->tgl_lahir }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <select name="sex" id="sex" class="form-control input-sm select2">
                                    ...
                                    @foreach ($data_sex as $sex)
                                        <option value="{{ $sex->id }}" {{ $sex->id == $penduduk->id_sex ? 'selected' : '' }}>{{ $sex->nama }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-7">
                                <select name="pendidikan" class="form-control input-sm select2" id="pendidikan">
                                    ...
                                    @foreach ($data_pendidikan_kk as $pendidikan)
                                        <option value="{{ $pendidikan->id }}" {{ $pendidikan->id == $penduduk->id_pendidikan ? 'selected' : '' }}>{{ $pendidikan->nama }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <select name="agama" class="form-control input-sm select2" id="agama">
                                    ...
                                    <option value="{{ $agama->id }}" {{ $agama->id == $penduduk->id_agama ? 'selected' : '' }}>
                                        {{ $agama->nama }}
                                    </option>
                                    @endforeach
                                </select>
