...
@section('title', 'Data Sarana Tempat Usaha')
        ...
        <div class="col-md-12">
            <div class="box box-info">
                <div class="box-header">
                    <a href="{{ url('/sarpras/tempat-usaha') }}" target="_blank" class="btn btn-social btn-info btn-flat btn-sm" style="margin-left: 5px" title="Lihat">
                        <i class="fa fa-eye"></i> Preview
                    </a>
                    <div class="pull-right">
                        <button type="button" class="btn btn-social btn-primary btn-flat btn-sm" data-toggle="modal" data-target="#tambahSaranaTU" title="Tambah Data">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-warning btn-sm" onclick="editSaranaTU({{ $p->id }})" data-toggle="modal" data-target="#editSaranaTU" title="Ubah Data">
...
<div class="modal fade" id="tambahSaranaTU">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ url('page/admin/sarana/tempat-usaha') }}" method="POST" id="formTambahSarana">
                ...
                <div class="modal-footer">
                    <button type="reset" class="btn btn-social btn-danger btn-flat btn-sm pull-left" data-dismiss="modal" title="Batal">
...
<div class="modal fade" id="editSaranaTU">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ url('page/admin/sarana/tempat-usaha') }}" method="POST" id="formEditSarana">
                @csrf
                @method('patch')
