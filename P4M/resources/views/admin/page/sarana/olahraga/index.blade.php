...
@section('title', 'Data Sarana Olahraga')
        ...
        <div class="col-md-12">
            <div class="box box-info">
                <div class="box-header">
                    <a href="{{ url('/sarpras/olahraga') }}" target="_blank" class="btn btn-social btn-info btn-flat btn-sm" style="margin-left: 5px" title="Lihat">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-sm btn-warning" onclick="editSaranaOlahraga({{ $p->id }})" data-toggle="modal" data-target="#editSaranaOlahraga" title="Ubah Data">
