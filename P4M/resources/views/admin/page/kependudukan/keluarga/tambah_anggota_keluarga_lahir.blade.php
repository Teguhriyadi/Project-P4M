...
<section class="content">
    <form action="{{ url('/page/admin/kependudukan/keluarga/tambah_data_anggota_keluarga_lahir/') }}" method="POST" enctype="multipart/form-data" id="formTambahPendudukLahir">
        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nik" id="nik" class="form-control input-sm" placeholder="Masukkan NIK" value="{{ $edit->no_kk }}" readonly>
                                </div>
                            </div>
                            <div class="col-sm-8">
                                <div class="form-group">
