            ...
            <div class="col-md-8">
                <div class="box box-primary">
                    <div class="box-header">
                        ...
                        <a href="{{ url('/page/admin/kependudukan/keluarga/') }}/rincian_keluarga" class="btn btn-social btn-flat btn-sm btn-info">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control input-sm" placeholder="Masukkan NIK" value="" readonly>
                                </div>
                            </div>
                            <div class="col-sm-8">
                                <div class="form-group">
                                    <label for="nama"> Kepala KK </label>
                                    <input type="text" class="form-control input-sm" placeholder="Masukkan Nama" value="" readonly>
                                </div>
                            </div>
