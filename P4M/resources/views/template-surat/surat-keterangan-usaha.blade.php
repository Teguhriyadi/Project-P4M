            ...
            <div class="box box-info">
                ...
                <form id="validasi" action="{{ url('/page/admin/cetak_surat/form/'.$detail_surat->url_surat) }}"  method="POST" class="form-horizontal" target="_blank">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="usaha" class="col-sm-4 col-lg-4"> Nama/Jenis Usaha </label>
                            <div class="col-sm-8">
                                <input type="text" name="usaha" id="usaha" class="form-control input-sm">
                            </div>
                        </div>
                        <div class="form-group">
            ...
            setupFormValidation: function()
            {
                $("#validasi").validate({
                    ...
                    messages: {
                        ...
                        usaha: {
                            required: "Nama/Jenis usaha harap di isi!"
                        },
                        keperluan: {
